...
Generated: 2026-01-11T11:33:06.634820
Cycle: 193

## What I Think I Know (Principles)

- **'Network' is a unifying concept across 7 domains** (confidence: 90%, compression: 45x)
...
- **disrupted neural** → **connectivity** (evidence: 2143)
- **the ecological** → **and consequences** (evidence: 1378)
- **and may** → **durable long** (evidence: 1181)
- **connectivity alone** → **small** (evidence: 1109)
- **of unknown** → **was linked** (evidence: 984)
